<x-layout>
    ...
    <div class="space-y-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-5">
            ...
            <div class="mt-2">
                <input id="name" type="text" name="name" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" :value="old('name')" />
            </div>
            @error('name')
    ...
    <div class="mt-10 flex items-center justify-center gap-x-6">
        ...
        <button type="submit" class="rounded-md bg-indigo-600 px-15 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register</button>
    </div>
    </form>
